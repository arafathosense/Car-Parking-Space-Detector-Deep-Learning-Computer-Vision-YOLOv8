...
model = YOLO(r"C:\Users\iTparK\Desktop\New folder\Car_Parking_Space_Detector\yolov8n.pt")
model.to(device)
...
cap = cv2.VideoCapture(r"C:\Users\iTparK\Desktop\New folder\Car_Parking_Space_Detector\parking_space.mp4")  # Change to the appropriate source if not using a webcam
# get vcap property
...
try:
    while True:
        ...
        cv2.imshow("Car Parking Space Detector", frame)
